...
1. Worktree 전용 coding-agent write sandbox
2. 신뢰된 project test command 실행기
3. Worktree diff → immutable Proposal 연동
4. Manual delivery E2E와 worktree cleanup
5. Auto/commit/PR delivery 모드
