...
1. Git dirty state, merge/rebase 상태와 repository별 동시 작업 lock
2. Worktree 전용 coding-agent write sandbox
3. 신뢰된 project test command 실행기
4. Worktree diff → immutable Proposal 연동
5. Manual delivery E2E와 worktree cleanup
