...
- 사용자 승인 기반 patch artifact와 외부 승인 handler는 아직 구현되지 않았다.
...
4. 비동기 job queue와 job status 조회 구현
5. 결과 diff 및 immutable proposal artifact 저장
6. Telegram 외부 승인 handler와 제한된 patch applier 구현
